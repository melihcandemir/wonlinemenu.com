export default function SectionTwo() {
  return (
    <div class="flex flex-col lg:flex-row items-center lg:items-start lg:space-x-8">
      <div class="flex-shrink-0 mb-6 w-full lg:mb-0 lg:w-1/2">
        {/* <h2 class="text-xl md:text-2xl text-center md:text-left font-normal text-gray-700 mb-3">
      ...
      <div class="flex-grow lg:w-1/2 text-center md:text-left">
        <h3 class="text-lg md:text-2xl text-gray-600">Nasıl çalışır?</h3>
