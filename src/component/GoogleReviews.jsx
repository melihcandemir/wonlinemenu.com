                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-300 ${isAnimating ? 'opacity-50' : 'opacity-100'}`}>
                        {visibleReviews.map((review, index) => (
                            <div
                                ...
                                className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 ${index === 0 ? 'block' : index === 1 ? 'hidden md:block' : 'hidden lg:block'
                                    }`}
                            >
                                {/* Kullanıcı Bilgileri */}
