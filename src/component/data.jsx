...
export const wGarson = [
  {
    ...
    content: (
      <a
        ...
        className="flex items-center gap-4 rounded-xl bg-green-600 px-6 py-3 font-bold text-white shadow-md transition hover:bg-green-700 cursor-pointer md:w-70"
      >
        <svg
          class="w-10 h-10"
          aria-hidden="true"
        ...
        <div class="text-left">
          <span class="block text-sm font-semibold">for Android</span>
          <span class="block text-lg uppercase leading-tight">
            İndir / Download
          </span>
        </div>
      </a>
